...
Все Strings, такие как names и lore, принимают цветовые коды, либо pre-1.16 `&a, &b, &c...`, либо hex коды в формате `#abc123` (заглавные буквы также работают).
В качестве альтернативы, если поставить два hex кода цвета в начале и конце string, например, `#123456Example#abcdef`, то будет создан цветовой градиент.
